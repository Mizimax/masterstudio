            ...
            <div class="activity-story --hover">
                @foreach ($stories as $story)
                    @php
                        ...
                        $activity['users_activity'] = \App\UserActivity::join('users', 'user_activities.user_id', 'users.user_id')->where('activity_id', $story['activity_id'])->where('user_activity_paid', 1)->get();
...
@section('script')
    ...
    <script>
      ...
      var facebook = function () {
        window.open('https://www.facebook.com/sharer/sharer.php?u={{ urlencode(Request::url()) }}', '_blank', 'width=600,height=400')
      }
